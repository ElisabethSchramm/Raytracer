...
public class ReflectiveMaterialView extends AMaterialView {

    private final ColorView difuseView;
    private final ColorView spectacularView;
    private final ColorView reflectionView;

    private final JTextField exponentField = new JTextField(2);

    public ReflectiveMaterialView(ColorView difuseView, ColorView spectacularView, ColorView reflectionView) {
    ...
    public void setPanel() {
        ...
        addComponent(panel, gbl, reflectionView.getPanel(), 0, 4, width, height, insets);
